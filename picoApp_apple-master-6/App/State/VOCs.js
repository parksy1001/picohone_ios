...
const FirstRoute = () => (
  <View style={{width: width, height: height * 0.5}}>
    <Graph state="Tvoc" day={6} />
  </View>
);

const SecondRoute = () => (
  <View style={{width: width, height: height * 0.5}}>
    <Graph state="Tvoc" day={5} />
  </View>
);

const ThirdRoute = () => (
  <View style={{width: width, height: height * 0.5}}>
    <Graph state="Tvoc" day={4} />
  </View>
);

const FourthRoute = () => (
  <View style={{width: width, height: height * 0.5}}>
    <Graph state="Tvoc" day={3} />
  </View>
);

const FifthRoute = () => (
  <View style={{width: width, height: height * 0.5}}>
    <Graph state="Tvoc" day={2} />
  </View>
);

const SixthRoute = () => (
  <View style={{width: width, height: height * 0.5}}>
    <Graph state="Tvoc" day={1} />
  </View>
);

const SeventhRoute = () => (
  <View style={{width: width, height: height * 0.5}}>
    <Graph state="Tvoc" day={0} />
  </View>
);

export const VOCsGraph = () => {
